...
print("The game will begin as soon as you shoose a direction.")
print("Use arrow keys to turn the snake.")
print("Try to eat the food.")
print("Try not to hit the walls or your own body.")
print("Try to get as big as possible -- Good luck!")
